...
public class SessionManager : MonoBehaviour
{
    ...
    /// <summary>Resources path to an <see cref="AudioMixer"/> asset (no extension), e.g. <c>Audio/Mixers/Audio_Mixer</c>.</summary>
    public string MatchAudioMixerResourcePath = "Audio/Mixers/Audio_Mixer";
