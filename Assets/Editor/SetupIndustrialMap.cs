...
//  6. Saves as prefab → Resources/Maps/IndustrialMap/IndustrialMap.prefab
...
public static class SetupIndustrialMap
{
    ...
    private const string PrefabSavePath =
        "Assets/Resources/Maps/IndustrialMap/IndustrialMap.prefab";

    private const string MaterialSavePath =
        "Assets/Resources/Maps/IndustrialMap/Materials";

    private static readonly string[] OldMapFolders =
    {
        "Assets/Resources/Maps/Map1",
        "Assets/Resources/Maps/Map2"
    };
    ...
    public static void Run(bool silent = false)
    {
        ...
        if (!AssetDatabase.IsValidFolder(MaterialSavePath))
            AssetDatabase.CreateFolder("Assets/Resources/Maps/IndustrialMap", "Materials");
