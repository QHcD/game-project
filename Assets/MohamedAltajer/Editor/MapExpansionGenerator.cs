...
{
    private const string ScenePath = "Assets/_Shared/Maps/Scenes/GameScene.unity";
    private const string ContainerName = "_MapExpansion_Container";
    private const string EnvironmentPrefabRoot = "Assets/_Shared/Imports/StarterAssets/Environment/Prefabs/";
